...
public enum EPCISVersion {
   ...
   *
   * @return fully qualified version ex: 1.1.0, 1.2.0, 2.0.0
   */
   ...
   * "schemaVersion": "2.0"
   *
   * @return compatible schemaVersion ex: 1.1, 1.2, 2.0
   */
   ...
   *
   * @param s input version provided by user ex: 2.0, 1.2, 1.1, 2.0.0, 1.2.0, 1.1.0.
   * @return EPCISVersion returned based on the provided version or schemaVersion string ex:
   *     VERSION_1_1_0, VERSION_1_2_0 or VERSION_2_0_0.
   */
